...
export default function StudentMessagesPage() {
  ...
  return (
    <div className="mx-auto flex h-[calc(100vh-60px)] max-w-7xl animate-slide-up">
      ...
      <div className={`flex w-full flex-col border-r border-white/[0.06] md:w-80 lg:w-96 ${selectedEducatorId ? "hidden md:flex" : "flex"}`}>
      ...
      {/* Right panel - Chat */}
      <div className={`flex-1 flex-col ${selectedEducatorId ? "flex" : "hidden md:flex"}`}>
        {selectedEducatorId ? (
          <>
            {/* Chat header */}
            <div className="flex items-center gap-3 border-b border-white/[0.06] px-6 py-4">
              <button
                onClick={() => setSelectedEducatorId(null)}
