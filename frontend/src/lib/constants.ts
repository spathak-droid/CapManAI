...
/** Full skill labels used in dashboards, challenge toasts, and student detail pages. */
...
/** Abbreviated skill labels used in compact contexts like heatmaps. */
...
/** Skill options with icons for challenge filters / selection UIs. */
export const SKILL_OPTIONS: { value: string; label: string; icon: string }[] = [
