...
export default function EducatorHome() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="animate-slide-up card-glow p-6 mb-8" style={{ animationDelay: "225ms" }}>
      ...
      >
        ...
        <Link
          ...
          className="card-glow p-5 text-center transition-all hover:scale-[1.02] hover:shadow-[0_0_28px_rgba(59,130,246,0.12)]"
        >
          <div className="h-10 w-10 mx-auto mb-2 flex items-center justify-center rounded-xl bg-cyan-500/10">
            <svg className="text-cyan-400 h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
